...
if($consulta!=null){
 echo 'enviando';
        ...
        $mensaje="Pinche en el siguiente enlace: "."https://practicausuario-mmarjusticia.c9users.io/php/cambiarClave.php?email=$destino&sha1=$sha1";
